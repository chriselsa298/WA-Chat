 ...
 * a schedule (Vercel Cron / external pinger). Authorization is shared
 * with `/api/flows/cron` — see `@/lib/cron/auth` for which headers and
 * secrets are accepted and why Vercel needs its own.
 *
